        ...
        if ($Password === $Confirm_Password) {
            ...
            if ($result) {
                ...
                try {
                    ...
                    //Recipients
                    $mail->setFrom('info@gictafrica.com', 'Alpha tech');
                    $mail->addAddress($email, $name);
                    //Content
                    $mail->isHTML(true);                                  //Set email format to HTML
                    $mail->Subject = 'Welecom To My Website';
                    $mail->Body    = '<p> This is the Verifecation Link<b><a href="http://localhost/login/?Verification=' . $Code . '">"http://localhost/login/?Verification=' . $Code . '"</a></b></p>';
